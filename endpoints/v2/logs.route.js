...
module.exports = function (end_b, app, contollers, authenticate, services, validations) {
  ...
  app.get(    end_b+'/logs/:log_id', validation.jwt.check, contollers.logs.get_time_log);
  app.put(    end_b+'/logs/:log_id', validation.jwt.check, contollers.logs.update_time_log);
  app.delete( end_b+'/logs/:log_id', validation.jwt.check, contollers.logs.remove_time_log);
