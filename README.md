...
This app consolodates all of you JIRA tasks, from all of your diferent accounts, into one easy to manage time tracking system.
...
```
git clone https://https://github.com/garrettH3S/Jiragation.git <repository_name>
```
